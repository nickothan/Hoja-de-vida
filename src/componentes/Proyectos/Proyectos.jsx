  ...
  const experiencias = [
    {
      title: 'Tic-Tac-Toe',
      desctipcion:
        'Tic-tac-toe game elaborated in react.js for two players, X and O, who take turns marking the spaces in a 3 × 3 grid. The player who manages to place three respective marks in a horizontal, vertical or diagonal row wins the game.',
